...
RESPONSES = [
    ...
    "Не выёбывайся я заболел", "Я его в рот ебал кстати", "А ты 5 правил кошерного еврея почитай", "Схуяли у нас бот как я в тг", "Вы че нейронку запустили?",
    "Ахахаха нахуй пошел копия ебаная ни фейма ни нейма пидарас, я твой создатель что в пенис что в яйца? Не слышу пидарас в зеркальной броне заблеванный",
    "Ооо бля шаблонщик еще", "Адрес диктуй", "Все пизда тебе", "Вот такие ещё фишечки я знаю на бизварчике", "Меня уже скоро совсем разбанят в аренке", "Всем пох",
    "сакатель пенисов он", "в пизду такие приколы", "Иди рыбе подрочи", "А ТЫ ИДИ НАХУЙ ХУЕСОС", "че ахуел бля?", "го арену", "кинь дс типов которые играют в арену",
    "ЕБАТЬ ЭТО ЧЕ ЗА НАХ", "да иди нахуй заебал уже", "войс?", "нашел ключ от главной спальни", 
]
